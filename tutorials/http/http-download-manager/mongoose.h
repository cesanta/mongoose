...
///#define MG_MAX_RECV_SIZE 4096*2
#endif
...
//
//#define MG_ERROR(args)   Logger::consoleLog(E_LOG_WARN, args)
//#define MG_INFO(args)    Logger::consoleLog(E_LOG_WARN, args)
//#define MG_DEBUG(args)   Logger::consoleLog(E_LOG_WARN, args)
//#define MG_VERBOSE(args) Logger::consoleLog(E_LOG_WARN, args)
