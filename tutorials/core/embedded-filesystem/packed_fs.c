...
static const unsigned char v2[] = {
 ...
 112,  41,  44,  32, 100, 111,  99, 117, 109, 101, 110, 116, // p), document
  46,  98, 111, 100, 121,  41,  59,  10,// .body);.
};
...
static const unsigned char v4[] = {
 ...
 123,  32, 119, 105, 100, 116, 104,  58,  32,  49,  48,  48, // { width: 100
  37,  59,  32, 125,  32, 125,  10,// %; } }.
};

const struct mg_mem_file mg_packed_files[] = {
  {"/web_root/index.html", v1, sizeof(v1), 1730991857},
  {"/web_root/main.js", v2, sizeof(v2), 1730991857},
  {"/web_root/preact.min.js", v3, sizeof(v3), 1730991857},
  {"/web_root/style.css", v4, sizeof(v4), 1730991857},
  {NULL, NULL, 0, 0}
};
