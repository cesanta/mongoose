...
- Open CubeMX. If you are starting a new project, select the STM32H747I-DISCO
  board and create a new project.
- In Clock Configuration, set the maximum clock frequency to 400 MHz.
- In the MCU pinout view, set pins PI11, PI12, and PI13 to GPIO_Output mode.
...
- In Pinout & Configuration / Connectivity, enable ETH in RMII mode and set pins
  PA1, PA2, PA7, PC1, PC4, PC5, PG11, PG12, and PG13 for Ethernet.
