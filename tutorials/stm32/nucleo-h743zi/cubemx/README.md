# Nucleo-H743ZI Mongoose Integration
...
- Open CubeMX. If you are starting a new project, select the STM32H743ZI
  microcontroller and create a new project.
- In Clock Configuration, set the maximum clock frequency to 480 MHz.
