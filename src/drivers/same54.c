...
struct GMAC_REGS_ {
  ...
  GMAC_RSR, GMAC_ISR, GMAC_IER, GMAC_IDR, GMAC_IMR, GMAC_MAN, GMAC_RPQ, GMAC_TPQ,
  GMAC_TPSF, GMAC_RPSF, GMAC_RJFML,
  Reserved1[13],
  GMAC_HRB, GMAC_HRT,
  GMAC_SAB0, GMAC_SAT0, GMAC_SAB1, GMAC_SAT1, GMAC_SAB2, GMAC_SAT2, GMAC_SAB3, GMAC_SAT3,
  GMAC_TIDM[4],
  GMAC_WOL, GMAC_IPGS, GMAC_SVLAN, GMAC_TPFCP,
  GMAC_SAMB1, GMAC_SAMT1,
  Reserved2[3],
  GMAC_NSC, GMAC_SCL, GMAC_SCH,
  GMAC_EFTSH, GMAC_EFRSH, GMAC_PEFTSH, GMAC_PEFRSH,
  Reserved3[2],
  GMAC_OTLO, GMAC_OTHI, GMAC_FT, GMAC_BCFT, GMAC_MFT, GMAC_PFT, GMAC_BFT64, GMAC_TBFT127,
  GMAC_TBFT255, GMAC_TBFT511, GMAC_TBFT1023, GMAC_TBFT1518, GMAC_GTBFT1518,
  GMAC_TUR, GMAC_SCF, GMAC_MCF, GMAC_EC, GMAC_LC, GMAC_DTF, GMAC_CSE,
  GMAC_ORLO, GMAC_ORHI, GMAC_FR, GMAC_BCFR, GMAC_MFR, GMAC_PFR, GMAC_BFR64, GMAC_TBFR127,
  GMAC_TBFR255, GMAC_TBFR511, GMAC_TBFR1023, GMAC_TBFR1518, GMAC_TMXBFR,
  GMAC_UFR, GMAC_OFR, GMAC_JR, GMAC_FCSE, GMAC_LFFE, GMAC_RSE, GMAC_AE, GMAC_RRE,
  GMAC_ROE, GMAC_IHCE, GMAC_TCE, GMAC_UCE,
  Reserved4[2],
  GMAC_TISUBN, GMAC_TSH,
  Reserved5,
  GMAC_TSSSL, GMAC_TSSN, GMAC_TSL, GMAC_TN, GMAC_TA, GMAC_TI,
  GMAC_EFTSL, GMAC_EFTN, GMAC_EFRSL, GMAC_EFRN,
  GMAC_PEFTSL, GMAC_PEFTN, GMAC_PEFRSL, GMAC_PEFRN,
  Reserved6[28],
  GMAC_RLPITR, GMAC_RLPITI, GMAC_TLPITR, GMAC_TLPITI;
};

struct GCLK_REGS_ {
  uint32_t GCLK_CTRLA_RESERVED, GCLK_SYNCBUSY, Reserved2[6],
  GCLK_GENCTRL[12], Reserved3[12], GCLK_PCHCTRL[48];
};
...
static void eth_write_phy(uint8_t addr, uint8_t reg, uint16_t val) {
  ...
  while (!(GMAC_REGS->GMAC_NSR & MG_BIT(2))); // Waiting until the write op is complete
}
