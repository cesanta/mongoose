...
void server(void *argument)
{
  ...
  mif.mac[0] = heth.Init.MACAddr[0];
  mif.mac[1] = heth.Init.MACAddr[1];
  mif.mac[2] = heth.Init.MACAddr[2];
  mif.mac[3] = heth.Init.MACAddr[3];
  mif.mac[4] = heth.Init.MACAddr[4];
  mif.mac[5] = heth.Init.MACAddr[5];
