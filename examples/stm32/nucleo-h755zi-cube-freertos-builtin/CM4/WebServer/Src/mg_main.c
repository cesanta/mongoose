...
#define LOCALLY_ADMINISTERED_MAC()                                 \
  {                                                                \
    MAC_ADDRESS_0, MAC_ADDRESS_1, MAC_ADDRESS_2,                   \
	MAC_ADDRESS_3, MAC_ADDRESS_4, MAC_ADDRESS_5                    \
  }
...
static void server(void *args) {
  ...
  struct mg_tcpip_if mif = {.mac = LOCALLY_ADMINISTERED_MAC(),
