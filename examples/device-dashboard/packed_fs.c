...
static const unsigned char v2[] = {
 ...
 116,  85, 115, 101, 114,  40, 117,  46, 117, 115, 101, 114, // tUser(u.user
  41,  59,  10,  32,  32,  32,  32, 119,  97, 116,  99, 104, // );.    watch
  40,  41,  59,  10,  32,  32,  32,  32, 114, 101, 116, 117, // ();.    retu
 114, 110,  32, 103, 101, 116,  99, 111, 110, 102, 105, 103, // rn getconfig
  40,  41,  59,  10,  32,  32, 125,  59,  10,  10,  32,  32, // ();.  };..  
  ...
  99, 101, 115, 115,  95, 116, 111, 107, 101, 110,  61,  59, // cess_token=;
 112,  97, 116, 104,  61,  47,  59, 109,  97, 120,  45,  97, // path=/;max-a
 103, 101,  61,  48,  96,  59,  10,  32,  32,  32,  32, 115, // ge=0`;.    s
 101, 116,  85, 115, 101, 114,  40,  39,  39,  41,  59,  10, // etUser('');.
  32,  32, 125,  59,  10,  10,  32,  32, 117, 115, 101,  69, //   };..  useE
 102, 102, 101,  99, 116,  40,  40,  41,  32,  61,  62,  32, // ffect(() => 
 123,  10,  32,  32,  32,  32,  47,  47,  32,  67,  97, 108, // {.    // Cal
 108, 101, 100,  32, 111, 110,  99, 101,  32,  97, 116,  32, // led once at 
 105, 110, 105, 116,  32, 116, 105, 109, 101,  10,  32,  32, // init time.  
 ...
 115,  99, 114, 105,  98, 101,  40, 109, 115, 103,  32,  61, // scribe(msg =
  ...
  41,  41,  59,  10,  32,  32,  32,  32, 102, 101, 116,  99, // ));.    fetc
 ...
 110,  61,  36, 123, 108, 111, 103, 105, 110, 125,  32,  47, // n=${login} /
  62,  96,  59,  10,  10,  32,  32, 114, 101, 116, 117, 114, // >`;..  retur
 110,  32, 104, 116, 109, 108,  96,  10,  60,  36, 123,  78, // n html`.<${N
  97, 118, 125,  32, 117, 115, 101, 114,  61,  36, 123, 117, // av} user=${u
 115, 101, 114, 125,  32, 108, 111, 103, 111, 117, 116,  61, // ser} logout=
  36, 123, 108, 111, 103, 111, 117, 116, 125,  32,  47,  62, // ${logout} />
 ...
 115,  61,  34, 114, 111, 119,  34,  62,  10,  32,  32,  32, // s="row">.   
  ...
  60,  36, 123,  72, 101, 114, 111, 125,  32,  47,  62,  60, // <${Hero} /><
  47, 100, 105, 118,  62,  10,  32,  32,  32,  32,  60, 100, // /div>.    <d
 105, 118,  32,  99, 108,  97, 115, 115,  61,  34,  99, 111, // iv class="co
 108,  32,  99, 111, 108,  45,  54,  34,  62,  60,  36, 123, // l col-6"><${
  67, 104,  97, 114, 116, 125,  32,  47,  62,  60,  47, 100, // Chart} /></d
 105, 118,  62,  10,  32,  32,  32,  32,  60, 100, 105, 118, // iv>.    <div
  32,  99, 108,  97, 115, 115,  61,  34,  99, 111, 108,  32, //  class="col 
  99, 111, 108,  45,  54,  34,  62,  10,  32,  32,  32,  32, // col-6">.    
  32,  32,  36, 123, 117, 115, 101, 114,  32,  61,  61,  32, //   ${user == 
  39,  97, 100, 109, 105, 110,  39,  32,  38,  38,  32, 104, // 'admin' && h
  40,  67, 111, 110, 102, 105, 103, 117, 114,  97, 116, 105, // (Configurati
 111, 110,  44,  32, 123,  99, 111, 110, 102, 105, 103, 125, // on, {config}
  41, 125,  10,  32,  32,  32,  32,  60,  47, 100, 105, 118, // )}.    </div
  62,  10,  32,  32,  32,  32,  60, 100, 105, 118,  32,  99, // >.    <div c
 108,  97, 115, 115,  61,  34,  99, 111, 108,  32,  99, 111, // lass="col co
 108,  45,  54,  34,  62,  60,  36, 123,  77, 101, 115, 115, // l-6"><${Mess
  97, 103, 101, 115, 125,  32,  99, 111, 110, 102, 105, 103, // ages} config
  61,  36, 123,  99, 111, 110, 102, 105, 103, 125,  32,  47, // =${config} /
...
static const struct packed_file {
  ...
  {"/web_root/main.js", v2, sizeof(v2), 1660395584},
