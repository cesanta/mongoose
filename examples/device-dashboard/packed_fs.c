...
static const unsigned char v6[] = {
 ...
 104, 105,  99, 104,  32, 114, 101, 116, 117, 114, 110, 115, // hich returns
  ...
  99, 107, 105, 110, 103,  32, 111, 110,  32,  97,  32, 115, // cking on a s
  97, 118, 101,  32,  98, 117, 116, 116, 111, 110,  32,  99, // ave button c
  97, 108, 108, 115,  32,  47,  97, 112, 105,  47, 115, 101, // alls /api/se
 116, 116, 105, 110, 103, 115,  47, 115, 101, 116,  10,  32, // ttings/set. 
  32,  32,  32,  32,  32,  32,  32,  32,  32,  65,  80,  73, //          API
  32,  99,  97, 108, 108,  34,  32,  47,  62,  10,  32,  32, //  call" />.  
  60,  47,  47,  62,  10,  10,  60,  47,  47,  62,  96,  59, // <//>..<//>`;
  10, 125,  59,  10,  10,  99, 111, 110, 115, 116,  32,  65, // .};..const A
 112, 112,  32,  61,  32, 102, 117, 110,  99, 116, 105, 111, // pp = functio
 110,  40, 123, 125,  41,  32, 123,  10,  32,  32,  99, 111, // n({}) {.  co
 110, 115, 116,  32,  91, 108, 111,  97, 100, 105, 110, 103, // nst [loading
  44,  32, 115, 101, 116,  76, 111,  97, 100, 105, 110, 103, // , setLoading
  93,  32,  61,  32, 117, 115, 101,  83, 116,  97, 116, 101, // ] = useState
  40, 116, 114, 117, 101,  41,  59,  10,  32,  32,  99, 111, // (true);.  co
 110, 115, 116,  32,  91, 117, 114, 108,  44,  32, 115, 101, // nst [url, se
 116,  85, 114, 108,  93,  32,  61,  32, 117, 115, 101,  83, // tUrl] = useS
 116,  97, 116, 101,  40,  39,  47,  39,  41,  59,  10,  32, // tate('/');. 
 ...
 115, 104, 111, 119,  83, 105, 100, 101,  98,  97, 114,  44, // showSidebar,
  32, 115, 101, 116,  83, 104, 111, 119,  83, 105, 100, 101, //  setShowSide
  98,  97, 114,  93,  32,  61,  32, 117, 115, 101,  83, 116, // bar] = useSt
  97, 116, 101,  40, 116, 114, 117, 101,  41,  59,  10,  10, // ate(true);..
 ...
 115, 116,  32, 108, 111, 103, 105, 110,  32,  61,  32, 114, // st login = r
  32,  61,  62,  32,  33, 114,  46, 111, 107,  32,  63,  32, //  => !r.ok ? 
 115, 101, 116,  76, 111,  97, 100, 105, 110, 103,  40, 102, // setLoading(f
  97, 108, 115, 101,  41,  32,  38,  38,  32, 115, 101, 116, // alse) && set
  85, 115, 101, 114,  40, 110, 117, 108, 108,  41,  32,  58, // User(null) :
  32, 114,  46, 106, 115, 111, 110,  40,  41,  10,  32,  32, //  r.json().  
  32,  32,  32,  32,  46, 116, 104, 101, 110,  40, 114,  32, //     .then(r 
  61,  62,  32, 115, 101, 116,  85, 115, 101, 114,  40, 114, // => setUser(r
  46, 117, 115, 101, 114,  41,  41,  10,  32,  32,  32,  32, // .user)).    
  32,  32,  46, 102, 105, 110,  97, 108, 108, 121,  40, 114, //   .finally(r
  32,  61,  62,  32, 115, 101, 116,  76, 111,  97, 100, 105, //  => setLoadi
 110, 103,  40, 102,  97, 108, 115, 101,  41,  41,  59,  10, // ng(false));.
  10,  32,  32, 117, 115, 101,  69, 102, 102, 101,  99, 116, // .  useEffect
  40,  40,  41,  32,  61,  62,  32, 102, 101, 116,  99, 104, // (() => fetch
  40,  39,  97, 112, 105,  47, 108, 111, 103, 105, 110,  39, // ('api/login'
  41,  46, 116, 104, 101, 110,  40, 108, 111, 103, 105, 110, // ).then(login
  41,  44,  32,  91,  93,  41,  59,  10,  10,  32,  32, 105, // ), []);..  i
 102,  32,  40, 108, 111,  97, 100, 105, 110, 103,  41,  32, // f (loading) 
 114, 101, 116, 117, 114, 110,  32,  39,  39,  59,  32,  32, // return '';  
  47,  47,  32,  83, 104, 111, 119,  32,  98, 108,  97, 110, // // Show blan
 107,  32, 112,  97, 103, 101,  32, 111, 110,  32, 105, 110, // k page on in
 105, 116, 105,  97, 108,  32, 108, 111,  97, 100,  10,  32, // itial load. 
  32, 105, 102,  32,  40,  33, 117, 115, 101, 114,  41,  32, //  if (!user) 
 114, 101, 116, 117, 114, 110,  32, 104, 116, 109, 108,  96, // return html`
  60,  36, 123,  76, 111, 103, 105, 110, 125,  32, 108, 111, // <${Login} lo
 103, 105, 110,  70, 110,  61,  36, 123, 108, 111, 103, 105, // ginFn=${logi
 110, 125,  32, 108, 111, 103, 111,  73,  99, 111, 110,  61, // n} logoIcon=
  36, 123,  76, 111, 103, 111, 125,  10,  32,  32,  32,  32, // ${Logo}.    
 116, 105, 116, 108, 101,  61,  34,  68, 101, 118, 105,  99, // title="Devic
 101,  32,  68,  97, 115, 104,  98, 111,  97, 114, 100,  32, // e Dashboard 
  76, 111, 103, 105, 110,  34,  32,  10,  32,  32,  32,  32, // Login" .    
 116, 105, 112,  84, 101, 120, 116,  61,  34,  84, 111,  32, // tipText="To 
 108, 111, 103, 105, 110,  44,  32, 117, 115, 101,  58,  32, // login, use: 
  ...
  50,  34,  32,  47,  62,  96,  59,  32,  47,  47,  32,  73, // 2" />`; // I
 102,  32, 110, 111, 116,  32, 108, 111, 103, 103, 101, 100, // f not logged
  32, 105, 110,  44,  32, 115, 104, 111, 119,  32, 108, 111, //  in, show lo
 103, 105, 110,  32, 115,  99, 114, 101, 101, 110,  10,  10, // gin screen..
  32,  32, 114, 101, 116, 117, 114, 110,  32, 104, 116, 109, //   return htm
 108,  96,  10,  60, 100, 105, 118,  32,  99, 108,  97, 115, // l`.<div clas
 115,  61,  34, 109, 105, 110,  45, 104,  45, 115,  99, 114, // s="min-h-scr
 101, 101, 110,  32,  98, 103,  45, 115, 108,  97, 116, 101, // een bg-slate
  45,  49,  48,  48,  34,  62,  10,  32,  32,  60,  36, 123, // -100">.  <${
  83, 105, 100, 101,  98,  97, 114, 125,  32, 117, 114, 108, // Sidebar} url
  61,  36, 123, 117, 114, 108, 125,  32, 115, 104, 111, 119, // =${url} show
  61,  36, 123, 115, 104, 111, 119,  83, 105, 100, 101,  98, // =${showSideb
  97, 114, 125,  32,  47,  62,  10,  32,  32,  60,  36, 123, // ar} />.  <${
  72, 101,  97, 100, 101, 114, 125,  32, 108, 111, 103, 111, // Header} logo
 117, 116,  61,  36, 123, 108, 111, 103, 111, 117, 116, 125, // ut=${logout}
  32, 117, 115, 101, 114,  61,  36, 123, 117, 115, 101, 114, //  user=${user
 125,  32, 115, 104, 111, 119,  83, 105, 100, 101,  98,  97, // } showSideba
 114,  61,  36, 123, 115, 104, 111, 119,  83, 105, 100, 101, // r=${showSide
  98,  97, 114, 125,  32, 115, 101, 116,  83, 104, 111, 119, // bar} setShow
  83, 105, 100, 101,  98,  97, 114,  61,  36, 123, 115, 101, // Sidebar=${se
 116,  83, 104, 111, 119,  83, 105, 100, 101,  98,  97, 114, // tShowSidebar
 125,  32,  47,  62,  10,  32,  32,  60, 100, 105, 118,  32, // } />.  <div 
  99, 108,  97, 115, 115,  61,  34,  36, 123, 115, 104, 111, // class="${sho
 ...
 100, 117, 114,  97, 116, 105, 111, 110,  45,  51,  48,  48, // duration-300
  ...
  10,  32,  32,  32,  32,  60,  36, 123,  82, 111, 117, 116, // .    <${Rout
 101, 114, 125,  32, 111, 110,  67, 104,  97, 110, 103, 101, // er} onChange
  61,  36, 123, 101, 118,  32,  61,  62,  32, 115, 101, 116, // =${ev => set
  85, 114, 108,  40, 101, 118,  46, 117, 114, 108,  41, 125, // Url(ev.url)}
  32, 104, 105, 115, 116, 111, 114, 121,  61,  36, 123,  72, //  history=${H
 105, 115, 116, 111, 114, 121,  46,  99, 114, 101,  97, 116, // istory.creat
 101,  72,  97, 115, 104,  72, 105, 115, 116, 111, 114, 121, // eHashHistory
  40,  41, 125,  32,  62,  10,  32,  32,  32,  32,  32,  32, // ()} >.      
  60,  36, 123,  77,  97, 105, 110, 125,  32, 100, 101, 102, // <${Main} def
  97, 117, 108, 116,  61,  36, 123, 116, 114, 117, 101, 125, // ault=${true}
  32,  47,  62,  10,  32,  32,  32,  32,  32,  32,  60,  36, //  />.      <$
 123,  83, 101, 116, 116, 105, 110, 103, 115, 125,  32, 112, // {Settings} p
  97, 116, 104,  61,  34, 115, 101, 116, 116, 105, 110, 103, // ath="setting
...
static const struct packed_file {
  ...
  {"/web_root/bundle.js", v1, sizeof(v1), 1685112525},
  {"/web_root/components.js", v2, sizeof(v2), 1685112525},
  {"/web_root/history.min.js", v3, sizeof(v3), 1685112525},
  {"/web_root/index.html", v4, sizeof(v4), 1685112525},
  {"/web_root/main.css", v5, sizeof(v5), 1685112525},
  {"/web_root/main.js", v6, sizeof(v6), 1685112525},
  {NULL, NULL, 0, 0}
};
