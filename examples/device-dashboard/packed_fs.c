...
static const unsigned char v2[] = {
 ...
 115,  46,  32,  84, 104, 105, 115,  32, 105, 115,  10,  32, // s. This is. 
  32,  97,  32,  60,  97,  32, 104, 114, 101, 102,  61,  34, //  a <a href="
 104, 116, 116, 112, 115,  58,  47,  47, 109, 111, 110, 103, // https://mong
 111, 111, 115, 101,  46, 119, 115,  47, 116, 117, 116, 111, // oose.ws/tuto
 114, 105,  97, 108, 115,  47, 104, 116, 116, 112,  45, 115, // rials/http-s
 101, 114, 118, 101, 114,  47,  34,  62, 104, 121,  98, 114, // erver/">hybr
 105, 100,  32, 115, 101, 114, 118, 101, 114,  60,  47,  97, // id server</a
  62,  32, 119, 104, 105,  99, 104,  10,  32,  32, 112, 114, // > which.  pr
 ...
 105, 110, 103,  32,  32,  60,  99, 111, 100, 101,  62,  99, // ing  <code>c
 117, 114, 108,  60,  47,  99, 111, 100, 101,  62,  32,  99, // url</code> c
 111, 109, 109,  97, 110, 100,  45, 108, 105, 110, 101,  32, // ommand-line 
 117, 116, 105, 108, 105, 116, 121,  58,  10,  32,  32,  60, // utility:.  <
  47, 112,  62,  10,  10,  32,  32,  60, 100, 105, 118,  62, // /p>..  <div>
 ...
 111,  99,  97, 108, 104, 111, 115, 116,  58,  56,  48,  48, // ocalhost:800
  ...
  47, 103, 101, 116,  60,  47,  99, 111, 100, 101,  62,  32, // /get</code> 
 ...
 101,  50,  61, 104, 101, 108, 108, 111,  39,  60,  47,  99, // e2=hello'</c
 111, 100, 101,  62,  32,  60,  47, 100, 105, 118,  62,  10, // ode> </div>.
  32,  32,  60, 100, 105, 118,  62,  60,  99, 111, 100, 101, //   <div><code
  62,  99, 117, 114, 108,  32, 108, 111,  99,  97, 108, 104, // >curl localh
 ...
 108, 108, 111,  39,  60,  47,  99, 111, 100, 101,  62,  32, // llo'</code> 
  60,  47, 100, 105, 118,  62,  10,  10,  32,  32,  60, 112, // </div>..  <p
  62,  10,  32,  32,  65,  32, 100, 101, 118, 105,  99, 101, // >.  A device
 ...
 116, 104, 105, 115,  32,  99, 111, 110, 115, 111, 108, 101, // this console
  ...
  34, 109, 115, 103,  34,  62,  10,  32,  32,  32,  32,  68, // "msg">.    D
 ...
 104, 101, 114,  32, 111, 112, 101, 110, 101, 100,  10,  32, // her opened. 
  ...
  46,  10,  32,  32,  60,  47, 100, 105, 118,  62,  60, 100, // ..  </div><d
 105, 118,  32,  99, 108,  97, 115, 115,  61,  34, 109, 115, // iv class="ms
 103,  34,  62,  10,  32,  32,  32,  32,  78, 111, 116, 101, // g">.    Note
 ...
 111, 116,  46,  10,  32,  32,  60,  47, 100, 105, 118,  62, // ot..  </div>
 ...
 104, 116, 109, 108,  96,  60, 100, 105, 118,  32, 115, 116, // html`<div st
 ...
 115,  61,  34, 113, 111, 115,  34,  62, 113, 111, 115,  58, // s="qos">qos:
  32,  36, 123, 109,  46, 109, 101, 115, 115,  97, 103, 101, //  ${m.message
  46, 113, 111, 115, 125,  32,  60,  47, 115, 112,  97, 110, // .qos} </span
  62,  10,  32,  32,  60, 115, 112,  97, 110,  32,  99, 108, // >.  <span cl
  97, 115, 115,  61,  34, 116, 111, 112, 105,  99,  34,  62, // ass="topic">
 116, 111, 112, 105,  99,  58,  32,  36, 123, 109,  46, 109, // topic: ${m.m
 101, 115, 115,  97, 103, 101,  46, 116, 111, 112, 105,  99, // essage.topic
 125,  32,  60,  47, 115, 112,  97, 110,  62,  10,  32,  32, // } </span>.  
  60, 115, 112,  97, 110,  32,  99, 108,  97, 115, 115,  61, // <span class=
  34, 100,  97, 116,  97,  34,  62, 100,  97, 116,  97,  58, // "data">data:
  32,  36, 123, 109,  46, 109, 101, 115, 115,  97, 103, 101, //  ${m.message
  46, 100,  97, 116,  97, 125,  60,  47, 115, 112,  97, 110, // .data}</span
  62,  10,  60,  47, 100, 105, 118,  62,  96,  59,  10,  10, // >.</div>`;..
 ...
 123, 101, 118,  32,  61,  62,  32, 115, 101, 116,  84, 120, // {ev => setTx
 ...
 105, 118,  32,  99, 108,  97, 115, 115,  61,  34, 109, 115, // iv class="ms
 103,  34,  62,  10,  32,  32,  32,  32,  77, 101, 115, 115, // g">.    Mess
 ...
 109,  97, 120,  32,  45,  32, 121, 109, 105, 110,  41,  32, // max - ymin) 
  ...
  60, 108, 105, 110, 101,  32, 120,  49,  61,  36, 123, 119, // <line x1=${w
  49, 125,  32, 121,  49,  61,  36, 123, 121, 125,  32, 120, // 1} y1=${y} x
  50,  61,  36, 123, 119, 125,  32, 121,  50,  61,  36, 123, // 2=${w} y2=${
 121, 125,  32,  99, 108,  97, 115, 115,  61,  34, 116, 105, // y} class="ti
 ...
 118, 125,  60,  47, 116, 101, 120, 116,  62,  96,  59,  10, // v}</text>`;.
 ...
 109, 105, 110,  32,  43,  32,  40, 120, 109,  97, 120,  32, // min + (xmax 
  ...
  32,  61,  62,  32, 104, 116, 109, 108,  96,  60, 112,  97, //  => html`<pa
 116, 104,  32, 100,  61,  34,  77,  32,  36, 123, 120, 125, // th d="M ${x}
  44,  36, 123, 104,  49, 125,  32,  76,  32,  36, 123, 120, // ,${h1} L ${x
 125,  44,  36, 123, 104,  32,  45,  32, 104,  50, 125,  34, // },${h - h2}"
 ...
 109, 108,  96,  60, 116, 101, 120, 116,  32, 120,  61,  36, // ml`<text x=$
 123, 120,  32,  45,  32,  49,  53, 125,  32, 121,  61,  36, // {x - 15} y=$
 123, 104,  32,  45,  32,  50, 125,  32,  99, 108,  97, 115, // {h - 2} clas
 115,  61,  34, 108,  97,  98, 101, 108,  34,  62,  36, 123, // s="label">${
 118, 125,  60,  47, 116, 101, 120, 116,  62,  96,  59,  10, // v}</text>`;.
 ...
 100,  32, 112, 108, 111, 116,  32, 116, 104, 101,  32, 100, // d plot the d
  97, 116,  97,  32,  97, 115,  32,  60, 112,  97, 116, 104, // ata as <path
  62,  32, 101, 108, 101, 109, 101, 110, 116,  10,  32,  32, // > element.  
 ...
 110,  32, 104, 116, 109, 108,  96,  10,  60, 115, 118, 103, // n html`.<svg
  32, 118, 105, 101, 119,  66, 111, 120,  61,  34,  48,  32, //  viewBox="0 
  48,  32,  36, 123, 119, 125,  32,  36, 123, 104, 125,  34, // 0 ${w} ${h}"
  62,  10,  32,  32,  60, 115, 116, 121, 108, 101,  62,  10, // >.  <style>.
  32,  32,  32,  32,  46,  97, 120, 105, 115,  32, 123,  32, //     .axis { 
 115, 116, 114, 111, 107, 101,  58,  32,  35,  97,  97,  97, // stroke: #aaa
  59,  32, 102, 105, 108, 108,  58,  32, 110, 111, 110, 101, // ; fill: none
  59,  32, 125,  10,  32,  32,  32,  32,  46, 108,  97,  98, // ; }.    .lab
 101, 108,  32, 123,  32, 115, 116, 114, 111, 107, 101,  58, // el { stroke:
  32,  35,  97,  97,  97,  59,  32, 102, 111, 110, 116,  45, //  #aaa; font-
 115, 105, 122, 101,  58,  32,  49,  51, 112, 120,  59,  32, // size: 13px; 
 125,  10,  32,  32,  32,  32,  46, 116, 105,  99, 107,  32, // }.    .tick 
 123,  32, 115, 116, 114, 111, 107, 101,  58,  32,  35,  99, // { stroke: #c
  99,  99,  59,  32, 102, 105, 108, 108,  58,  32, 110, 111, // cc; fill: no
 110, 101,  59,  32, 115, 116, 114, 111, 107, 101,  45, 100, // ne; stroke-d
  97, 115, 104,  97, 114, 114,  97, 121,  58,  32,  53,  59, // asharray: 5;
  32, 125,  10,  32,  32,  32,  32,  46, 115, 101, 114, 105, //  }.    .seri
 101, 115,  98, 103,  32, 123,  32, 115, 116, 114, 111, 107, // esbg { strok
 101,  58,  32, 110, 111, 110, 101,  59,  32, 102, 105, 108, // e: none; fil
 108,  58,  32, 114, 103,  98,  97,  40,  50,  48,  48,  44, // l: rgba(200,
  50,  50,  53,  44,  50,  53,  53,  44,  32,  48,  46,  50, // 225,255, 0.2
  53,  41, 125,  10,  32,  32,  32,  32,  46, 115, 101, 114, // 5)}.    .ser
 105, 101, 115,  32, 123,  32, 115, 116, 114, 111, 107, 101, // ies { stroke
  58,  32,  35,  50,  53,  97,  59,  32, 102, 105, 108, 108, // : #25a; fill
  58,  32, 110, 111, 110, 101,  59,  32, 125,  10,  32,  32, // : none; }.  
  60,  47, 115, 116, 121, 108, 101,  62,  10,  32,  32,  36, // </style>.  $
 ...
 109,  97, 112,  40, 105,  32,  61,  62,  32, 120, 116, 116, // map(i => xtt
  ...
  32,  32,  60, 112,  97, 116, 104,  32, 100,  61,  34,  36, //   <path d="$
 123,  98, 101, 103, 105, 110, 125,  32,  36, 123, 115, 101, // {begin} ${se
 114, 105, 101, 115,  46, 106, 111, 105, 110,  40,  39,  32, // ries.join(' 
  39,  41, 125,  32,  36, 123, 101, 110, 100, 125,  34,  32, // ')} ${end}" 
  99, 108,  97, 115, 115,  61,  34, 115, 101, 114, 105, 101, // class="serie
 115,  98, 103,  34,  32,  47,  62,  10,  32,  32,  60, 112, // sbg" />.  <p
  97, 116, 104,  32, 100,  61,  34,  36, 123,  98, 101, 103, // ath d="${beg
 105, 110,  48, 125,  32,  36, 123, 115, 101, 114, 105, 101, // in0} ${serie
 115,  46, 106, 111, 105, 110,  40,  39,  32,  39,  41, 125, // s.join(' ')}
  34,  32,  99, 108,  97, 115, 115,  61,  34, 115, 101, 114, // " class="ser
 105, 101, 115,  34,  32,  47,  62,  10,  60,  47, 115, 118, // ies" />.</sv
 103,  62,  96,  59,  10, 125,  59,  10,  10,  10,  99, 111, // g>`;.};...co
 ...
 110, 100,  58,  32,  35, 101,  99,  51,  59,  32,  99, 111, // nd: #ec3; co
 108, 111, 114,  58,  32,  35, 102, 102, 102,  59,  32, 112, // lor: #fff; p
  97, 100, 100, 105, 110, 103,  58,  32,  48,  46,  52, 101, // adding: 0.4e
 109,  59,  34,  62,  68,  97, 116,  97,  32,  67, 104,  97, // m;">Data Cha
 114, 116,  60,  47, 104,  51,  62,  10,  32,  32,  60, 100, // rt</h3>.  <d
 105, 118,  32, 115, 116, 121, 108, 101,  61,  34, 111, 118, // iv style="ov
 101, 114, 102, 108, 111, 119,  58,  32,  97, 117, 116, 111, // erflow: auto
  59,  32, 112,  97, 100, 100, 105, 110, 103,  58,  32,  48, // ; padding: 0
  46,  53, 101, 109,  59,  34,  32,  99, 108,  97, 115, 115, // .5em;" class
  61,  34,  34,  62,  10,  32,  32,  32,  32,  60,  36, 123, // ="">.    <${
 ...
 118,  32,  99, 108,  97, 115, 115,  61,  34, 109, 115, 103, // v class="msg
  34,  62,  10,  32,  32,  32,  32,  84, 104, 105, 115,  32, // ">.    This 
 ...
 115,  61,  34,  99, 111, 108,  32,  99, 111, 108,  45,  54, // s="col col-6
  34,  62,  10,  32,  32,  32,  32,  32,  32,  36, 123, 117, // ">.      ${u
 ...
 110, 102, 105, 103, 125,  32,  47,  62,  60,  47, 100, 105, // nfig} /></di
