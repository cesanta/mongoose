...
static const unsigned char v6[] = {
 ...
 116, 105, 111, 110,  32,  77,  97, 105, 110,  40, 123, 125, // tion Main({}
  41,  32, 123,  10,  32,  32,  99, 111, 110, 115, 116,  32, // ) {.  const 
  91, 115, 116,  97, 116, 115,  44,  32, 115, 101, 116,  83, // [stats, setS
 116,  97, 116, 115,  93,  32,  61,  32, 117, 115, 101,  83, // tats] = useS
 ...
 115, 104,  44,  32,  91,  93,  41,  59,  10,  32,  32, 105, // sh, []);.  i
 102,  32,  40,  33, 115, 116,  97, 116, 115,  41,  32, 114, // f (!stats) r
 101, 116, 117, 114, 110,  32,  39,  39,  59,  10,  32,  32, // eturn '';.  
 114, 101, 116, 117, 114, 110,  32, 104, 116, 109, 108,  96, // return html`
  10,  60, 100, 105, 118,  32,  99, 108,  97, 115, 115,  61, // .<div class=
  34, 112,  45,  50,  34,  62,  10,  32,  32,  60, 100, 105, // "p-2">.  <di
 ...
 103,  97, 112,  45,  52,  34,  62,  10,  32,  32,  32,  32, // gap-4">.    
  60,  36, 123,  83, 116,  97, 116, 125,  32, 116, 105, 116, // <${Stat} tit
 108, 101,  61,  34,  84, 101, 109, 112, 101, 114,  97, 116, // le="Temperat
 117, 114, 101,  34,  32, 116, 101, 120, 116,  61,  34,  36, // ure" text="$
 123, 115, 116,  97, 116, 115,  46, 116, 101, 109, 112, 101, // {stats.tempe
 114,  97, 116, 117, 114, 101, 125,  32, 194, 176,  67,  34, // rature} ..C"
  32, 116, 105, 112,  84, 101, 120, 116,  61,  34, 103, 111, //  tipText="go
 111, 100,  34,  32, 116, 105, 112,  73,  99, 111, 110,  61, // od" tipIcon=
  36, 123,  73,  99, 111, 110, 115,  46, 111, 107, 125,  32, // ${Icons.ok} 
 116, 105, 112,  67, 111, 108, 111, 114, 115,  61,  36, 123, // tipColors=${
 116, 105, 112,  67, 111, 108, 111, 114, 115,  46, 103, 114, // tipColors.gr
 101, 101, 110, 125,  32,  47,  62,  10,  32,  32,  32,  32, // een} />.    
  60,  36, 123,  83, 116,  97, 116, 125,  32, 116, 105, 116, // <${Stat} tit
 108, 101,  61,  34,  72, 117, 109, 105, 100, 105, 116, 121, // le="Humidity
  34,  32, 116, 101, 120, 116,  61,  34,  36, 123, 115, 116, // " text="${st
  97, 116, 115,  46, 104, 117, 109, 105, 100, 105, 116, 121, // ats.humidity
 125,  32,  37,  34,  32, 116, 105, 112,  84, 101, 120, 116, // } %" tipText
  61,  34, 119,  97, 114, 110,  34,  32, 116, 105, 112,  73, // ="warn" tipI
  99, 111, 110,  61,  36, 123,  73,  99, 111, 110, 115,  46, // con=${Icons.
 119,  97, 114, 110, 125,  32, 116, 105, 112,  67, 111, 108, // warn} tipCol
 111, 114, 115,  61,  36, 123, 116, 105, 112,  67, 111, 108, // ors=${tipCol
 111, 114, 115,  46, 121, 101, 108, 108, 111, 119, 125,  32, // ors.yellow} 
  47,  62,  10,  32,  32,  32,  32,  60, 100, 105, 118,  32, // />.    <div 
  99, 108,  97, 115, 115,  61,  34,  98, 103,  45, 119, 104, // class="bg-wh
 105, 116, 101,  32,  99, 111, 108,  45, 115, 112,  97, 110, // ite col-span
  45,  50,  32,  98, 111, 114, 100, 101, 114,  32, 114, 111, // -2 border ro
 ...
 111, 112, 101, 114,  78, 111, 116, 101, 125,  32, 116, 101, // operNote} te
 120, 116,  61,  34,  83, 116,  97, 116, 115,  32, 100,  97, // xt="Stats da
 116,  97,  32, 105, 115,  32, 114, 101,  99, 101, 105, 118, // ta is receiv
 101, 100,  32, 102, 114, 111, 109,  32, 116, 104, 101,  32, // ed from the 
  77, 111, 110, 103, 111, 111, 115, 101,  32,  98,  97,  99, // Mongoose bac
 107, 101, 110, 100,  34,  32,  47,  62,  10,  32,  32,  32, // kend" />.   
  32,  60,  47,  47,  62,  10,  32,  32,  60,  47,  47,  62, //  <//>.  <//>
  10,  32,  32,  60, 100, 105, 118,  32,  99, 108,  97, 115, // .  <div clas
 115,  61,  34, 112,  45,  52,  32, 115, 109,  58, 112,  45, // s="p-4 sm:p-
  50,  32, 109, 120,  45,  97, 117, 116, 111,  32, 103, 114, // 2 mx-auto gr
 105, 100,  32, 103, 114, 105, 100,  45,  99, 111, 108, 115, // id grid-cols
  45,  49,  32, 108, 103,  58, 103, 114, 105, 100,  45,  99, // -1 lg:grid-c
 111, 108, 115,  45,  50,  32, 103,  97, 112,  45,  52,  34, // ols-2 gap-4"
  62,  10,  10,  32,  32,  32,  32,  60,  36, 123,  67, 104, // >..    <${Ch
  97, 114, 116, 125,  32, 100,  97, 116,  97,  61,  36, 123, // art} data=${
 115, 116,  97, 116, 115,  46, 112, 111, 105, 110, 116, 115, // stats.points
 125,  32,  47,  62,  10,  10,  32,  32,  32,  32,  60, 100, // } />..    <d
 105, 118,  32,  99, 108,  97, 115, 115,  61,  34, 109, 121, // iv class="my
  45,  52,  32, 104, 120,  45,  50,  52,  32,  98, 103,  45, // -4 hx-24 bg-
 ...
 116,  61,  34,  84, 104, 105, 115,  32,  99, 104,  97, 114, // t="This char
 116,  32, 105, 115,  32,  97, 110,  32,  83,  86,  71,  32, // t is an SVG 
 105, 109,  97, 103, 101,  44,  32, 103, 101, 110, 101, 114, // image, gener
  97, 116, 101, 100,  32, 111, 110,  32, 116, 104, 101,  32, // ated on the 
 102, 108, 121,  32, 102, 114, 111, 109,  32, 116, 104, 101, // fly from the
  10,  32,  32,  32,  32,  32,  32,  32,  32, 100,  97, 116, // .        dat
  97,  32, 114, 101, 116, 117, 114, 110, 101, 100,  32,  98, // a returned b
 121,  32, 116, 104, 101,  32,  97, 112, 105,  47, 115, 116, // y the api/st
  97, 116, 115,  47, 103, 101, 116,  32,  65,  80,  73,  32, // ats/get API 
  99,  97, 108, 108,  34,  32,  47,  62,  10,  32,  32,  32, // call" />.   
  32,  60,  47,  47,  62,  10,  32,  32,  60,  47,  47,  62, //  <//>.  <//>
...
static const struct packed_file {
  ...
  {"/web_root/bundle.js", v1, sizeof(v1), 1692212839},
  {"/web_root/components.js", v2, sizeof(v2), 1692212839},
  {"/web_root/history.min.js", v3, sizeof(v3), 1692212839},
  {"/web_root/index.html", v4, sizeof(v4), 1692212839},
  {"/web_root/main.css", v5, sizeof(v5), 1692212839},
  {"/web_root/main.js", v6, sizeof(v6), 1692434459},
  {"/certs/server_cert.pem", v7, sizeof(v7), 1692431954},
  {"/certs/server_key.pem", v8, sizeof(v8), 1692431988},
  {NULL, NULL, 0, 0}
};
