...
static const unsigned char v2[] = {
 ...
 110, 115, 116,  32, 108, 111, 103, 111, 117, 116,  32,  61, // nst logout =
  32, 101, 118,  32,  61,  62,  32, 123,  10,  32,  32,  32, //  ev => {.   
  32, 100, 111,  99, 117, 109, 101, 110, 116,  46,  99, 111, //  document.co
 111, 107, 105, 101,  32,  61,  32,  96,  97,  99,  99, 101, // okie = `acce
 115, 115,  95, 116, 111, 107, 101, 110,  61,  59,  32,  83, // ss_token=; S
 101,  99, 117, 114, 101,  44,  32,  72, 116, 116, 112,  79, // ecure, HttpO
 110, 108, 121,  59,  32,  83,  97, 109, 101,  83, 105, 116, // nly; SameSit
 101,  61,  76,  97, 120,  59,  32, 112,  97, 116, 104,  61, // e=Lax; path=
  47,  59,  32, 109,  97, 120,  45,  97, 103, 101,  61,  48, // /; max-age=0
  96,  59,  10,  32,  32,  32,  32, 115, 101, 116,  85, 115, // `;.    setUs
 101, 114,  40,  39,  39,  41,  59,  10,  32,  32, 125,  59, // er('');.  };
  10,  10,  32,  32, 117, 115, 101,  69, 102, 102, 101,  99, // ..  useEffec
 116,  40,  40,  41,  32,  61,  62,  32, 123,  10,  32,  32, // t(() => {.  
  32,  32,  47,  47,  32,  67,  97, 108, 108, 101, 100,  32, //   // Called 
 111, 110,  99, 101,  32,  97, 116,  32, 105, 110, 105, 116, // once at init
  32, 116, 105, 109, 101,  10,  32,  32,  32,  32,  80, 117, //  time.    Pu
  98,  83, 117,  98,  46, 115, 117,  98, 115,  99, 114, 105, // bSub.subscri
  98, 101,  40, 109, 115, 103,  32,  61,  62,  32, 109, 115, // be(msg => ms
 103,  46, 110,  97, 109, 101,  32,  61,  61,  32,  39,  99, // g.name == 'c
 111, 110, 102, 105, 103,  39,  32,  38,  38,  32, 103, 101, // onfig' && ge
 116,  99, 111, 110, 102, 105, 103,  40,  41,  41,  59,  10, // tconfig());.
 ...
 110,  40, 114,  41,  41,  10,  32,  32,  32,  32,  32,  32, // n(r)).      
  ...
  39,  39,  41,  41,  59,  10,  32,  32, 125,  44,  32,  91, // ''));.  }, [
 ...
 111, 119,  34,  62,  10,  32,  32,  32,  32,  60, 100, 105, // ow">.    <di
 118,  32,  99, 108,  97, 115, 115,  61,  34,  99, 111, 108, // v class="col
  32,  99, 111, 108,  45,  54,  34,  62,  60,  36, 123,  72, //  col-6"><${H
 101, 114, 111, 125,  32,  47,  62,  60,  47, 100, 105, 118, // ero} /></div
  62,  10,  32,  32,  32,  32,  60, 100, 105, 118,  32,  99, // >.    <div c
 108,  97, 115, 115,  61,  34,  99, 111, 108,  32,  99, 111, // lass="col co
 108,  45,  54,  34,  62,  60,  36, 123,  67, 104,  97, 114, // l-6"><${Char
 116, 125,  32,  47,  62,  60,  47, 100, 105, 118,  62,  10, // t} /></div>.
  32,  32,  32,  32,  60, 100, 105, 118,  32,  99, 108,  97, //     <div cla
 115, 115,  61,  34,  99, 111, 108,  32,  99, 111, 108,  45, // ss="col col-
  54,  34,  62,  10,  32,  32,  32,  32,  32,  32,  36, 123, // 6">.      ${
 117, 115, 101, 114,  32,  61,  61,  32,  39,  97, 100, 109, // user == 'adm
 105, 110,  39,  32,  38,  38,  32, 104,  40,  67, 111, 110, // in' && h(Con
 102, 105, 103, 117, 114,  97, 116, 105, 111, 110,  44,  32, // figuration, 
 123,  99, 111, 110, 102, 105, 103, 125,  41, 125,  10,  32, // {config})}. 
  32,  32,  32,  60,  47, 100, 105, 118,  62,  10,  32,  32, //    </div>.  
  32,  32,  60, 100, 105, 118,  32,  99, 108,  97, 115, 115, //   <div class
...
static const struct packed_file {
  ...
  {"/web_root/main.js", v2, sizeof(v2), 1661520054},
